...
@section('content')
			...
			<div class="hidden lg:grid lg:grid-cols-6">
				...
				<div>
					<img class="hover:-translate-y-1 hover:scale-110 hover:border"
						src="images/Birmingham-metropolitan.png" alt="">
				</div>
				<!-- Img 3 -->
				<div>
					<img class="hover:-translate-y-1 hover:scale-110 hover:border"
						src="images/business-school-london.png" alt="">
				</div>
				<!-- Img 4 -->
				<div>
	...
	<section class="container mx-auto overflow-hidden pb-5">
		<h3 class="font-bold text-4xl text-center py-9 mx-2 md:mx-0"> How to Order An Assignment</h2>
	...
	<section class="bg-[#EDEDED] p-5 mt-5 overflow-hidden">
		<div class="container mx-auto text-center">
			...
			<!------------- Courses Div 1 ----------->
			<div
				class="grid grid-cols-1 gap-1 sm:gap-2 md:gap-2 lg:gap-4 xl:gap-4 2xl:gap-4 sm:grid-cols-2: md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 pt-10 ">
				<div class="hover:-translate-y-1 hover:scale-100 cursor-pointer bg-white shadow-2xl rounded-lg p-1 ">
				...
				<div class="p-0">
					<div class=" block shadow-2xl rounded-lg  bg-white h-full z-10">
						...
						<div class="p-6 bg-orange-500 rounded text-center">
							<h4 class="text-white uppercase mb-4 text-xl">
								<strong>Transparent Price</strong>
							</h4>
						</div>
	...
	<!--------Free Features------------>
	<section class="p-5 mt-5 overflow-hidden">
		<div class="container mx-auto">
	...
	<!-- Girl Background -->
	<section class="mt-5 bg-gradient-to-br from-[#FCA00F] to-orange-200  h-fit pb-5 overflow-hidden">
		<div class="container mx-auto">
			<div class="p-8 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
				<!-- Column 1 for mobile -->
				...
				<div class="">
					<div class="hidden sm:hidden md:hidden lg:grid rounded p-10 h-fit  bg-[#FDC875] mt-10 ml-5">
						<!-- 1st -->
						<div class="flex">
				...
				<div class="hover:scale-105 hidden sm:hidden md:hidden lg:grid ">
					<img src="images/student-education.png" class="" alt="">
				</div>
	...
	<section class="bg-white overflow-hidden pb-8  ">
		<div class="container  mx-auto p-5">
			<h4 class="text-2xl  font-bold mt-4">
				Here’s what people have to say about our essays
			</h4>
			<p>
				From Bristol to Birmingham and beyond, we have helped hundreds of students pass their courses with our
			...
			<div
				...
				<div class="grid-cols-1 outline outline-[#F78C03] rounded">
				...
				<div class=" col-span-2 pb-8 ">
					<div class="outline outline-[#F78C03] rounded p-5 bg-white">
						<div class="container mx-auto p-4">
							...
							<!-- Our Happy Customer -->
							<div class="grid sm:grid-cols-1 gap-x-2 mt-4">
								<div class="flex">
									<div class="p-2">
										<div class="rounded-lg p-2 bg-[#FDC875] absolute overflow-hidden">
									...
									<div class="ml-32 p-2">
										...
										<p class="font-medium text-[#6D6C6C] text-sm lg:text-xl">Based on 88 reviews</p>
										<!--  Stars -->
										<div class="flex ">
	...
	<section class="bg-white overflow-hidden pb-8 p-3">
		<div class="container mx-auto">
			...
			<div>
				<div class="grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8 space-y-5">
					<!-- First -->
