...
<div class="container mx-auto">
    ...
    <nav class="border-gray-200 px-2 mb-10">
        <div class=" flex items-center justify-between">
            <a href="<?php echo e(route('home')); ?>" class="flex">
            ...
            <div class="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
                <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                    <li class="lg:flex">
                        ...
                        <a href="<?php echo e(route('blog')); ?>" class="ext-base font-bold lg:text-lg text-gray-900 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-white md:p-0">Blog</a>
                    ...
                    <li class="lg:flex">
                        ...
                        <div @click.away="open = false" class="relative whitespace-nowrap inline-flex" x-data="{ open: false }">
                            <a @click="open = !open" class="block w-full text-left font-semibold cursor-pointer hover:text-[#6ec1e4] <?php echo e(request()->routeIs('service.show') ? '  text-primary-one' : ''); ?>">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                ...
                                <div class="px-2 py-2 rounded-md shadow bg-white">
                                    ...
                                    <?php if(!empty($services)): ?>
                                        ...
                                        href="<?php echo e(route('service.show',$service->slug)); ?>"><?php echo e($service->name); ?></a>
...
<?php /**PATH E:\Syed Faraz Shahid\blog\resources\views/partials/frontend/navbar.blade.php ENDPATH**/ ?>