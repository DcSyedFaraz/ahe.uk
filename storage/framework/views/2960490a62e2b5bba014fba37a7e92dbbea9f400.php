                        ...
                        <div class=" grid grid-cols-1 md:grid-cols-2 gap-4 p-8 ">
                            ...
                            <div class="">
                              <label class="text-md text-gray-600 font-bold">Phone</label>
                                <input type="tel" name="Phone" id="phone" class="contact-input" placeholder=" Enter Phone Number" value="<?php echo e(old('phone')); ?>"
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Syed Faraz Shahid\blog\resources\views/pages/contact.blade.php ENDPATH**/ ?>